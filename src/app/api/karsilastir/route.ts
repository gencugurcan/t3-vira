...
const SISTEM_MESAJI = `Sen bir girişim ekosistemi analiz asistanısın. Sana iki girişimin özet verisi verilecek. Bu iki girişimi KISA (2-4 cümle), gerekçeli bir paragrafla karşılaştır.
KURALLAR:
